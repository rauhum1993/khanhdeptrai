...
customer_gender,customer_id_card,customer_phone,customer_email,customer_address)
	values 	(4,1,'Hải','1968-12-20','1',18730113,039336258,'haiquacustomer_addressytay@gmail.com','Hà Tĩnh' ),
			(1,2,'Tùng','1995-11-16','0',18452213,069876258,'asda@gmail.com','Quảng Truong' ),
			(2,2,'Tùng','1995-11-16','1',18452213,069876258,'asda@gmail.com','Quảng Truong' ),
			(3,2,'Tùng','1995-11-16','0',18452213,069876258,'asda@gmail.com','Quảng Truong' ),
			(5,2,'Tùng','1995-11-16','1',18452213,069876258,'asda@gmail.com','Quảng Truong' ),
			(6,3,'khanh','1995-11-16','0',18452213,231321,'asdsa@gmail.com','Quảng Ninh' ),
			(7,4,'Linh','1995-11-16','1',18452213,2313,'sadas@gmail.com','Vinh' ),
			(8,3,'Thao','1995-11-16','0',18452213,069876258,'bxcb@gmail.com','Quảng Bình' ),
			(9,5,'Tan','1995-11-16','1',18452213,069876258,'erte@gmail.com','Hue' ),
			(10,3,'Giang','1995-11-16','1',76456465,069876258,'tungquayxe@gmail.com','Quảng Tri' ),
			(11,3,'Mai','1995-11-16','1',6446464646,069876258,'asdsa@gmail.com','Quảng Nam' ),
			(12,3,'Nghia','1995-11-16','1',18452213,069876258,'dfsd@gmail.com','Quảng Ngai' ),
			(13,4,'Trang','1995-11-16','1',123132131,069876258,'fadas@gmail.com','Quảng Chau' ),
			(14,5,'Vietlot','1997-06-20','1',196320113,037936588,'vbvbv@gmail.com','Đà Nẵng' );
