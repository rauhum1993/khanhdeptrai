                    ...
                    <div class="col-xs-8">
                        <div class="row">
                            ...
                            <div class="col-xs-7"><!-- Search form -->
                                <form id="formSearch" action="/customer">
                                    <input type="hidden" name="action" value="search">
                                    <div class="row">
                                        <div class="col-xs-8"><input name="valueSearch" class="form-control" type="text" placeholder="Search"
                                                                     aria-label="Search"></div>
                                        <div class="col-xs-4"><button style="height: 100%" type="submit"><i class="fa fa-search"></i></button></div>
                                    </div>
                                </form>
                            </div>
                        </div>
